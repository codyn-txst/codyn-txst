<!-- header banner -->
[![Banner](https://user-images.githubusercontent.com/74038190/213910845-af37a709-8995-40d6-be59-724526e3c3d7.gif)](https://github.com/codyn-txst)

# Cody Neal ⚡️  
**Software Engineer | Backend & Infrastructure | Automation & DevOps**

## ⚙️ Tech & Tools  
<p>
  <img alt="Node.js" src="https://img.shields.io/badge/Node.js-339933?logo=node.js&logoColor=fff&style=flat" />
   <img alt="JavaScript" src="https://img.shields.io/badge/Javascript-F7DF1E?logo=javascript&logoColor=fff&style=flat" />
...
## 🚀 What I Build  
- Backend services (Next.js APIs, Express.js, Python microservices) integrated into systems like FOLIO, Islandora, ArchivesSpace, SPAs, and custom ETL pipelines
...
- DevOps setups: reverse proxies, log management, monitoring, and deployment environments on Linux/RHEL & AWS
...
- Custom integrations for digital-preservation & library ecosystems
